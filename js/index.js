    ...
    productList.forEach((item) => {
      productListDiv += `<div class="card mt-2" style="width: 10rem;">
                          ...
                          <div class="card-body">
                            ...
                            <a href="#" class="btn btn-outline-info" id="addCart">담기</a>
                          </div>
                        </div>`
    })
...
//                 <img src="img/핫아메리카노.png" class="card-img-top" alt="...">
//                 <div class="card-body">
//                   <b class="card-title">따듯한 아메리카노</b>
//                   <p class="card-text text-danger">2500원</p>
...
document.getElementById("loginSpan").addEventListener("click", async (e) => {
